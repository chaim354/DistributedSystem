...
public class ZooKeeperPeerServerImpl extends Thread implements ZooKeeperPeerServer {
    ...
    public ZooKeeperPeerServerImpl(int myPort, long peerEpoch, Long id, Map<Long, InetSocketAddress> peerIDtoAddress) {
        ...
        this.jFollower = new JavaRunnerFollower(this.incomingMessages,this.outgoingMessages);
        this.robinLeader = new RoundRobinLeader(this.incomingMessages,this.outgoingMessages,peerIDtoAddress,myAddress);
        try {
